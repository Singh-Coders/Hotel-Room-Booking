<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustInfoDemo.aspx.cs" Inherits="HDemo.CustInfoDemo" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#"><b>Customers</b></a>
                        </li>
                        <li class="nav-item">
        ...
        <center>
            <div runat="server" id="rptr" class="rptr" style="margin-top: 80px; padding: 100px 0 100px 0;">
                <table style="width: 100%;">
                    <tr>
                        <th colspan="2">Customers Information
                        </th>
                    </tr>
                    <tr>
                        <td>Name</td>
