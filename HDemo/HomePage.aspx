<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="HDemo.HomePage" %>
...
<body class="w3-light-grey">
        ...
        <div class="w3-bar w3-white w3-large">
            ...
            <a href="#contact" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile" id="bbtn">Book Now</a>
            <%--<asp:Button ID="bbtn1" runat="server" Text="Book Now" class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile" />--%>
        </div>
        <!-- Header -->
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="Images/hpbi1.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="800"/>
        ...
        <div class="w3-content" style="max-width: 1532px;">
            ...
            <div class="w3-row-padding w3-padding-16">
                <div class="w3-third w3-margin-bottom">
                    <img src="Images/roomi1.jpeg" alt="Norway" style="width: 100%" />
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="Images/funhalli1.jpg" alt="Norway" style="width: 100%" />
                    <div class="w3-container w3-white">
                        <h3>Double Room</h3>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="Images/gardi1.jpg" alt="Norway" style="width: 100%" />
                    <div class="w3-container w3-white">
                        <h3>Deluxe Room</h3>
            ...
            <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
                <div class="w3-half w3-margin-bottom">
                    <div class="w3-display-container">
                        <img src="Images/roomi1.jpeg" alt="Cinque Terre" style="width: 100%" />
                ...
                <div class="w3-half">
                    <div class="w3-row-padding" style="margin: 0 -16px">
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="Images/roomi1.jpeg" alt="New York" style="width: 100%" />
                                <span class="w3-display-bottomleft w3-padding">New York</span>
                            </div>
                        </div>
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="Images/roomi1.jpeg" alt="San Francisco" style="width: 100%" />
                    ...
                    <div class="w3-row-padding" style="margin: 0 -16px">
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="Images/roomi1.jpeg"" alt="Pisa" style="width: 100%" />
                                <span class="w3-display-bottomleft w3-padding">Pisa</span>
                            </div>
                        </div>
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="Images/roomi1.jpeg" alt="Paris" style="width: 100%" />
            ...
            <div class="w3-container" id="contact">
                ...
                <form action="/action_page.php" target="_blank">
                    ...
                    <p>
                        <button class="w3-button w3-black w3-padding-large" type="submit">SEND MESSAGE</button></p>
                </form>
            </div>
